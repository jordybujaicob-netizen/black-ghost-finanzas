  ...
  return (
    <div
      className="
        ...
        px-4
        py-3.5
        shadow-[0_24px_75px_rgba(0,0,0,0.70)]
        backdrop-blur-2xl
      "
    >
...
function ExpensePieChart({
          ...
          (
            ...
            color:
              ...
              COLORES_PREDETERMINADOS[
                indice %
                  COLORES_PREDETERMINADOS.length
              ],
          })
        )
        .filter(
  ...
  const totalGeneral =
    useMemo(() => {
      return datosNormalizados.reduce(
        (total, categoria) =>
          total +
          categoria.total,
        0
      ...
      >
        <div className="text-center">
          ...
          <p
            ...
            "
          >
            No existen gastos reales en el
        ...
        >
          <PieChart>
            ...
            <Pie
              ...
              filter="url(#blackghost-pie-shadow)"
            >
